...
def main():
    ...
    st.markdown("""<div style="text-align:center;background-color:#1F618D;padding:15px;border-radius:10px;color:white;">
        ...
        if prompt:
            ...
            with st.spinner("🧠 Gemini yanıt oluşturuyor..."):
                try:
                    ...
                    docs = RETRIEVER.invoke(prompt)  # <-- BURASI DÜZELTİLDİ
    ...
    with col2:
        ...
        st.markdown("- Kalbin en güçlü odacığı nedir? Sebebini açıklar mısın?")
